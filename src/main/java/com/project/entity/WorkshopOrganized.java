...
public class WorkshopOrganized {
	...
	public String toString() {
		return "WorkshopOrganized [sr_No=" + sr_No + ", name_of_organized=" + name_of_organized
				+ ", no_of_participents=" + no_of_participents + ", date_conducted=" + date_conducted + ", getSr_No()="
				+ getSr_No() + ", getName_of_organized()=" + getName_of_organized() + ", getNo_of_participents()="
				+ getNo_of_participents() + ", getDate_conducted()=" + getDate_conducted() + ", getClass()="
